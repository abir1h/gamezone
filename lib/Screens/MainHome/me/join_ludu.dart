...
class room_details_ludo extends StatefulWidget {
  final String id,type;
  room_details_ludo({this.id,this.type});
  @override
  _room_details_ludoState createState() => _room_details_ludoState();
}

class _room_details_ludoState extends State<room_details_ludo> {
  Future slide;
                        ...
                        child:Container(
                          child: Column(
                            children: [
                              Container(
                                  height: height/2.5,
                                  child: Image.asset('Images/f5.jpeg')),
                                    ...
                                    Expanded(
                                      child: Padding(
                                        ...
                                        child: Container(
                                          ...
                                          mainAxisAlignment: MainAxisAlignment.center,
                                          children: [
                                            Text("Board Type :",style: TextStyle(color: Colors.grey,fontWeight: FontWeight.bold,),),

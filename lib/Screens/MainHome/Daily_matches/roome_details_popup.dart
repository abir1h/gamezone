...
class room_details_pop extends StatefulWidget {
  final String id;
  room_details_pop({this.id});


  @override
  _room_details_popState createState() => _room_details_popState();
}

class _room_details_popState extends State<room_details_pop> {
  Future slide;
  var message;
                ...
                Container(
                    ...
                    child: FutureBuilder(
                        ...
                        builder: (_, AsyncSnapshot snapshot) {
                                                    ...
                                                    child: Padding(
                                                      ...
                                                      child: Container(
                                                        ...
                                                        children: [
                                                          ...
                                                          Flexible(child: Text(snapshot.data[0]['type'],style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,),)),
                                                        ],
                                                      )
                                                    ...
                                                    child: Padding(
                                                      ...
                                                      child: Container(
                                                        ...
                                                        children: [
                                                          ...
                                                          Flexible(child: Text(snapshot.data[0]['version'],style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,),)),
                                                        ],
                                                      )
                                                    ...
                                                    child: Padding(
                                                      ...
                                                      child: Container(
                                                        ...
                                                        children: [
                                                          ...
                                                          Flexible(child: Text(snapshot.data[0]['map'],style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,),)),
                                                        ],
                                                      )
                                                    ...
                                                    child: Padding(
                                                      ...
                                                      child: Container(
                                                        decoration: BoxDecoration(
                                                          ...
                                                          children: [
                                                            message!=null?Text("Room Details",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,),):Text(''),
                                                            Row(
                                                            mainAxisAlignment: MainAxisAlignment.center,
                                                            children: [
                                                              Flexible(child: Padding(
                                                                padding: const EdgeInsets.all(8.0),
                                                                child: SelectableText(message!=null?message:"Room Details Will be shared Before 8 to 10 minutes of  match.",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,),),
                                                              )),
                                                            ],
                                                      ),
                          ...
                          return   Text("Not Uploaded Yet!!", style: GoogleFonts.lato(
                            color: Colors.black,
                            fontSize: 14,
                            fontWeight: FontWeight.w600,));
                        })),

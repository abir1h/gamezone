...
class Full_map_Free_fire extends StatefulWidget {
  final String type;
  Full_map_Free_fire({this.type});
  @override
  _Full_map_Free_fireState createState() =>
      _Full_map_Free_fireState();
}

class _Full_map_Free_fireState
    extends State<Full_map_Free_fire> {
  Future slide;

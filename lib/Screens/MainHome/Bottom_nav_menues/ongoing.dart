...
class ongoing_list extends StatefulWidget {
  @override
  _ongoing_listState createState() => _ongoing_listState();
}

class _ongoing_listState extends State<ongoing_list> {
  Future slide;
  Future<List<dynamic>> emergency() async {
    ...
    var response =
    await http.get(Uri.parse(AppUrl.ongoin), headers: requestHeaders);
